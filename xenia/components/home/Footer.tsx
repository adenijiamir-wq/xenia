    ...
    <footer className="bg-charcoal-900 text-white mt-20">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-scarlet-500 mb-4">XENIA</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-charcoal-300">
              ...
              <li><Link href="/sell" className="hover:text-white transition-colors">Sell on XENIA</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-charcoal-800 text-center text-charcoal-400 text-sm">
          <p>&copy; 2024 XENIA. All rights reserved. Made with ❤️ for Rutgers students.</p>
        </div>
      </div>
    </footer>
  );
